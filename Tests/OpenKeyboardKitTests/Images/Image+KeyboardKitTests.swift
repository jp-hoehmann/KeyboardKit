...
class Image_KeyboardKitTests: XCTestCase {
    ...
    func testKeyboardImagesAreDefined() {
        ...
        XCTAssertEqual(result(for: .keyboardArrowLeft), Image(systemName: "arrow.left"))
        XCTAssertEqual(result(for: .keyboardArrowRight), Image(systemName: "arrow.right"))
        XCTAssertEqual(result(for: .keyboardArrowUp), Image(systemName: "arrow.up"))
        XCTAssertEqual(result(for: .keyboardArrowDown), Image(systemName: "arrow.down"))
