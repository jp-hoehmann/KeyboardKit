...
class Keyboard_LayoutTypeTests: XCTestCase {
    ...
    func testCanCreateFromId() {
        ...
        XCTAssertEqual(create(withId: "dvorak"), .dvorak)
    ...
    func testDisplayNameIsValidForAllTypes() {
        ...
        XCTAssertEqual(displayName(for: .dvorak), "Dvorak")
    ...
    func testIdIsValidForAllTypes() {
        ...
        XCTAssertEqual(id(for: .dvorak), "dvorak")
        ...
        XCTAssertEqual(id(for: .vietnamese_telex(.dvorak)), "vietnamese_telex_dvorak")
        ...
        XCTAssertEqual(id(for: .vietnamese_viqr(.dvorak)), "vietnamese_viqr_dvorak")
        ...
        XCTAssertEqual(id(for: .vietnamese_vni(.dvorak)), "vietnamese_vni_dvorak")
